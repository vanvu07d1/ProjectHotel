...
@NamedQueries({
    ...
    @NamedQuery(name = "Reservation.findByReqRoomtype", query = "SELECT r FROM Reservation r WHERE r.reqRoomtype = :reqRoomtype")})
public class Reservation implements Serializable {
    ...
    public Reservation(Integer reservationId, int numberOfPeople, Date dateIn, Date dateOut, String reqRoomtype) {
        this.reservationId = reservationId;
