...
import sessionbean.UsedserviceFacadeLocal;
...
public class UsedServiceStub {
    ...
    private UsedserviceFacadeLocal lookupUsedserviceFacadeLocal() {
        try {
            ...
            return (UsedserviceFacadeLocal) c.lookup("java:global/ProjectHotel/ProjectHotel-ejb/UsedserviceFacade!sessionbean.UsedserviceFacadeLocal");
