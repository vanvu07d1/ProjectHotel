...
import sessionbean.CheckoutFacadeLocal;
...
public class CheckoutStub {
    ...
    private CheckoutFacadeLocal lookupCheckoutFacadeLocal() {
        try {
            ...
            return (CheckoutFacadeLocal) c.lookup("java:global/ProjectHotel/ProjectHotel-ejb/CheckoutFacade!sessionbean.CheckoutFacadeLocal");
