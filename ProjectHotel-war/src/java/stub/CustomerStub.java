...
public class CustomerStub {
    ...
    private CustomerFacadeLocal lookupCustomerFacadeLocal() {
        try {
            ...
            return (CustomerFacadeLocal) c.lookup("java:global/ProjectHotel/ProjectHotel-ejb/CustomerFacade!sessionbean.CustomerFacadeLocal");
    ...
    public Customer findByIdCard(String idCard) {
        return customerFacade.findByIdCard(idCard);
    }
