...
import sessionbean.CheckinFacadeLocal;
...
public class CheckinStub {
    ...
    private CheckinFacadeLocal lookupCheckinFacadeLocal() {
        try {
            ...
            return (CheckinFacadeLocal) c.lookup("java:global/ProjectHotel/ProjectHotel-ejb/CheckinFacade!sessionbean.CheckinFacadeLocal");
    ...
    public Checkin findByRoomId(int id) {
        return checkinFacade.findByRoomId(id);
    }
