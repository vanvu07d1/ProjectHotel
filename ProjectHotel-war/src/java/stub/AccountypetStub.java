...
import sessionbean.AccounttypeFacadeLocal;

/**
 *
 * @author Willi
 */
public class AccountypetStub {
    ...
    private AccounttypeFacadeLocal lookupAccounttypeFacadeLocal() {
        try {
            ...
            return (AccounttypeFacadeLocal) c.lookup("java:global/ProjectHotel/ProjectHotel-ejb/AccounttypeFacade!sessionbean.AccounttypeFacadeLocal");
