...
import sessionbean.RoomFacadeLocal;
...
public class RoomStub {
    ...
    private RoomFacadeLocal lookupRoomFacadeLocal() {
        try {
            ...
            return (RoomFacadeLocal) c.lookup("java:global/ProjectHotel/ProjectHotel-ejb/RoomFacade!sessionbean.RoomFacadeLocal");
    ...
    public List<Room> findByRoomTypeId(int typeId) {
        return roomFacade.findByRoomTypeId(typeId);
    }

    public Room findByRoomName(String name) {
        return roomFacade.findByRoomName(name);
    }
